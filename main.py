...
bot_token = '6526453150:AAG1MR_RAJk9Bm0m1BXo7IcbK8wPgCqBnOE' 
bot = telebot.TeleBot(bot_token)

allowed_group_id = -814368320
...
def getkey(message):
    ...
    print(key)
    url_key = requests.get(f'https://link4m.co/api-shorten/v2?api=64d513f47792e26dc52c47ec&url=yourdestinationlink.com&url=http://soncoi169.000webhostapp.com/index.html?key={key}').json()['shortenedUrl']
    
    text = f'''
- LINK KEY {TimeStamp()}:{url_key} 
- DÙNG LỆNH /nhapkey {{key}} ĐỂ TIẾP TỤC -
...
def lqm_sms(message):
    ...
    if phone_number in ['113','911','114','115','+84325716345','0936649355','0965757721','0332715355','0862492415']:
...
┏━━━━━━━━━━━━━━━━━━━━┓
┣➤ - Sử dụng lệnh để lấy key. [/getkey]             
┣➤ - Chạy bot spam gọi điện + sms. [/spam]
┣➤ - Khi lấy key xong, sử dụng lệnh để kiểm tra. [/nhapkey]
...
┣➤ - Lấy key xong, sử dụng lệnh để kiểm tra. [/nhapkey]
